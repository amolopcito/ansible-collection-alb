...
EXAMPLES = '''
  - name: Get SAML Session
    amolopcito.alb.avi_saml_api_session:
...
try:
    ...
    from ansible_collections.amolopcito.alb.plugins.module_utils.saml_avi_api import OktaSAMLApiSession, OneloginSAMLApiSession
    HAS_REQUESTS = True
except ImportError:
    HAS_REQUESTS = False
